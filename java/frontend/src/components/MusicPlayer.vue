...
const playlist = ref([
  {
    ...
    src: '/src/assets/music/nature.mp3',
    duration: 180 // 3分钟
  },
  {
    title: '古典音乐 - 月光奏鸣曲',
    artist: 'Beethoven',
    src: '/src/assets/music/moonlight.mp3',
    duration: 240 // 4分钟
  },
  {
    title: '爵士乐 - 夜曲',
    artist: 'Jazz Night',
    src: '/src/assets/music/jazz.mp3',
    duration: 200 // 3分20秒
  },
  {
    title: '电子音乐 - 未来之声',
    artist: 'Future Sound',
    src: '/src/assets/music/electronic.mp3',
    duration: 160 // 2分40秒
  },
  {
    title: '民谣 - 山间小路',
    artist: 'Folk Music',
    src: '/src/assets/music/folk.mp3',
    duration: 220 // 3分40秒
  }
])
